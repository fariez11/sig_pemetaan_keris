...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand bg-info navbar-light border-bottom" style="left: 0; position: fixed; right: 0; top: 0;">
    <!-- Left navbar links -->
    <!-- <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <img src="assets/img/admin.png" class="img-circle" width="45" style="margin-top: -10px;color: black;">
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="text-center" style="padding: 10px;border-bottom: 1px solid #4f5962;">
            <img class="profile-user-img img-fluid img-circle" src="assets/img/admin.png" alt="User profile picture">
            
            <h3 class="brand-text profile-username text-center" style="color: white;">{{Session::get('NAMA')}}</h3>
            <p class="brand-text text-muted text-center" style="color: white;">Admin</p>
        </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
              <a href="/data_keris" class="nav-link">
              <i class="nav-icon fa fa-table"></i>
              <p>Data Keris</p>
            </a>
          </li>
          <li class="nav-item">
              <a href="/data_pemilik" class="nav-link">
              <i class="nav-icon fa fa-table"></i>
              <p>Data Pemilik</p>
            </a>
          </li>
          <li class="nav-item">
              <a href="/data_galeri" class="nav-link">
              <i class="nav-icon fa fa-table"></i>
              <p>Data Galeri</p>
            </a>
          </li>
